...
(function () {
  ...
  // Ничего не грузим автоматически при открытии страницы — и список HWID,
  // и лог верификаций открываются только по нажатию своей кнопки
  // «Обновить», чтобы не захламлять страницу сразу большими таблицами.
})();
